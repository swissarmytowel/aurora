...
export default class PathFollowing extends Steering {
    ...
    constructor(owner, route, force = 1, isLoop = false, ownerMaxSpeed = 100, distSqErr = 10e1, deceleration = 0.3) {
        ...
        this.getImpulse = PathFollowing.standardFollowing;
        this.deceleration = deceleration;
        if(route.length == 1) {
            this.isLoop = false;
            this.getImpulse = PathFollowing.arrive;
        }
    }

    static standardFollowing(owner, target) {
    ...
    static arrive(owner, targetVector) {
